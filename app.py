...
@app.route('/conclusion')  # Route for the conclusion page
def conclusion():
    active_page = 'conclusion'
    # Add any specific logic for the conclusion page if needed
    return render_template('conclusion.html', active_page=active_page)
